...
- (void)viewDidLoad {
    ...
    self.detailViewController = (DetailViewController *)[self.navigationController topViewController];
}
...
- (void)configureCell:(UITableViewCell *)cell withObject:(NSManagedObject *)object {
    ...
    //
    NSString *cellTitleLabel = [dateFormatter stringFromDate:date];
    
    cell.textLabel.text = cellTitleLabel;
    cell.detailTextLabel.text = [object valueForKey:@"foodName"];
